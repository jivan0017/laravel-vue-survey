...
// import QuestionEditor from '../../components/survey/editor/QuestionEditor.vue';
import QuestionEditor from '../../components/survey/editor/QuestionEditor.vue';
import store from '../../store';
import { ref, reactive } from 'vue';
import { useRoute, useRouter } from 'vue-router';
import axios from "axios";
// import router from "../../../../procedimiento_base.md";
...
if (route.params.id) {
  ...
  console.log("from surveyView, model.value > ", model.value.questions)
}
...
function saveSurvey(event) {
  ...
  store.dispatch("saveSurvey", model.value)
    .then(({ data }) => {
      console.log("saveSurvey >>> ", data.data.id)
...
function uploadImage(idEntity) {
  let dataFiles = new FormData();

  dataFiles.append('image', model.value.image_file_content);
  dataFiles.append('idEntity', idEntity);
  store.dispatch("upload", dataFiles)
    .then((res) => {
      console.log(">>>>>>>>>>>>>>>>> ", res);
...
function onImageChoose(event) {
  ...
  // model.value.image = file;
  // model.value.image_url = file;
  model.value.image_file_content = file
